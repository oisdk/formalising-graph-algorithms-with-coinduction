...
open import Data.Maybe using () renaming (nothing to ⌈⊤⌉; just to ⌈_⌉) public
...
StrictPartialOrder.conn ub-sord {⌈⊤⌉} {⌈ x ⌉} p q = absurd (q Poly.tt)
StrictPartialOrder.conn ub-sord {⌈ x ⌉} {⌈⊤⌉} p q = absurd (p Poly.tt)
...
TotalOrder.≰⇒> ub-ord {x} {⌈⊤⌉} p = absurd (p Poly.tt)
